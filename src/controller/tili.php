...
function luoVaihtoavain($email, $baseurl='') {
    ...
    // Tuodaan henkilo-mallin tietokanta-funktiot käyttöön.
    require_once(MODEL_DIR . 'henkilo.php');

    // Lisätään vaihtoavain tietokantaan ja lähetetään käyttäjälle sähköpostia.
    // Jos tämä onnistui, palautetaan vaihtoavain ja sähköpostiosoite.
    // Muuten palautetaan virhekoodi, joka ilmoittaa, että jokin lisäyksessä epäonnistui.
